...
**Not:** Bazı kanllar silinmemiş görünmektedir. Birkaç dakkaya düzelir merak etmeyin.`)).then(resulter => {
...
message.guild.roles.create({ data: { name: '・Mensch-Güvenlik' }, reason: 'ayn' }).then(s => s.setColor('#f70c0c'))
